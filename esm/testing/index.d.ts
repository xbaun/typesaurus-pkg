 ...
 */
export declare function injectTestingAdaptor(ctx: Promise<RulesTestContext>): Promise<void>;
/**
...
export declare function setupJestAfterEnv(config: TestEnvironmentConfig, clb?: (env: RulesTestEnvironment) => testing.RulesTestContext): void;
